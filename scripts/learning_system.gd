...
var mentors := {
    "fisher":{"skills":["sailing","foraging"],"min_rel":1},
    "marek":{"skills":["trade"],"min_rel":1},
    "archmage":{"skills":["magic"],"min_rel":1},
    "captain_guard":{"skills":["labor","politics"],"min_rel":1},
    "undertaker":{"skills":["foraging","medicine"],"min_rel":1},
    "priest":{"skills":["medicine"],"min_rel":1},
    "smuggler":{"skills":["stealth","trade"],"min_rel":1}
}
